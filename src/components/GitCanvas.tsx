...
export const GitCanvas = ({
  ...
  const { pendingDragOp, onNodeDrag, onNodeDragStop, handleModalConfirm, handleModalCancel, ghostElements } =
    useDragHandlers({ canDrag, layout, gitState, mode, doCherryPick, doRebase, doMerge, setGhostCommand, t });
  ...
  const nodes: Node[] = useMemo(() => {
    ...
    return result;
  }, [layout, gitState.commits, gitState.branches, headCommitId, headLayout, canBranch, canCheckout, canReset, canSquash, canDrag, headAncestors, isDetachedHead, wip, highlightNodeIds, isEmpty]);
  ...
  const onNodeClick: NodeMouseHandler = useCallback(
    ...
    [canBranch, canCheckout, canReset, canSquash, headCommitId, headAncestors, gitState.branches, doAddCommit, doStartWip, doCreateBranch, doCheckout, doResetHard, doSquash]
  );
