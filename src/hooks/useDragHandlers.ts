...
export const useDragHandlers = ({ canDrag, layout, gitState, mode, doCherryPick, doRebase, doMerge, setGhostCommand, t }: Params) => {
  ...
  const ancestorSet = useCallback(
    (tipId: string): Set<string> => {
